...
public class NendIconModule {
				...
				for (NendAdIconView holdIconView : holdNendAd.arrayList) {
					if (holdIconView == iconView) {
						...
						case onClickInformation:
							NendIconModule.onInformationClick();
							NendIconModule.onInformationClickWithSpotId(intSpotID);
							break;
						default:
							break;
						}
		...
		activity.runOnUiThread(new Runnable() {
			public void run() {
				if (!mNendAdIconHashMap.containsKey(spotID)) {
					...
					iconLoader.setOnInformationClickListener(sOnInformationClickListener);
	...
	private static OnInformationClickListener sOnInformationClickListener = new OnInformationClickListener() {
		@Override
		public void onClickInformation(NendAdIconView nendAdIconView) {
			eventListener(EventListenerType.onClickInformation, nendAdIconView);
		}
	};
	...
	public static native void onInformationClick();
	public static native void onInformationClickWithSpotId(final int spotId);
}
